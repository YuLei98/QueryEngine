...
import (
	"QueryEngine/searcher/arrays"
	"QueryEngine/searcher/dump"
	"QueryEngine/searcher/model"
	"QueryEngine/searcher/pagination"
	"QueryEngine/searcher/sorts"
	"QueryEngine/searcher/storage"
...
func (e *Engine) Init() {
	...
	for shard := 0; shard < e.Shard; shard++ {
		...
		// fmt.Println(fmt.Sprintf("%s.%d", e.Option.KeyIndexName, shard))
